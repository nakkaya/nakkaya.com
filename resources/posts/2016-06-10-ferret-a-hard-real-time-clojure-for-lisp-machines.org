...
computers running Linux/Mac OS X/Windows.
 ...
 - [[http://dropbox.nakkaya.com/builds/ferret-manual.html][Project Home Page]]
...
#+begin_src clojure
  ;; saw.clj
  (configure-runtime! FERRET_DISABLE_OUTPUT_STREAM true ;; Disable Serial
...
#+begin_src clojure
  ...
  (defn motors
    ...
    ([m1 m2]
     "zumo_motors.setSpeeds(m1.to<int>(), m2.to<int>());"))
