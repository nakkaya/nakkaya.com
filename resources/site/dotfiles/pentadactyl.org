...
#+BEGIN_SRC fundamental :mkdirp yes :tangle ~/.pentadactylrc
  set strictfocus=base.nakkaya.com:laissez-faire,google.com:laissez-faire,'chrome:*':laissez-faire,*:despotic
#+END_SRC

#+BEGIN_SRC fundamental :mkdirp yes :tangle ~/.pentadactylrc
  autocmd LocationChange base.nakkaya.com :normal! <C-z>
#+END_SRC
